...
namespace Domainr.EventStore.SqlServer.Tests.IntegrationTests
{
    ...
    public sealed class SqlServerEventStoreTests
        : SqlEventStoreTests<SqlServerEventStore<string>>
    {
        [OneTimeSetUp]
        ...
        protected override SqlServerEventStore<string> CreateSqlEventStore()
        {
            return new SqlServerEventStore<string>(
                MockLogger.Object,
                Settings,
                MockSqlStatementsLoader.Object,
                MockEventDataSerializer.Object);
        }
    }
}